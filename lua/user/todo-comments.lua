...
todo_comments.setup {
  ...
  --   },
  --   TODO = { icon = icons.ui.Check, alt = { "TIP" } },
  --   HACK = { icon = icons.ui.Fire },
  --   WARN = { icon = icons.diagnostics.Warning, alt = { "WARNING", "XXX" } },
  --   PERF = { icon = icons.ui.Dashboard, alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE", "TEST" } },
  --   NOTE = { icon = icons.ui.Note, alt = { "INFO" } },
  -- },
