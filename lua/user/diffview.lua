  ...
  keymaps = {
    ...
    view = {
      ...
      { "n", "]x", diffview.actions.next_conflict, { desc = "In the merge-tool: jump to the next conflict" } },
      {
        "n",
        "<leader>co",
        diffview.actions.conflict_choose "ours",
        { desc = "Choose the OURS version of a conflict" },
      },
      {
        "n",
        "<leader>ct",
        diffview.actions.conflict_choose "theirs",
        { desc = "Choose the THEIRS version of a conflict" },
      },
      {
        "n",
        "<leader>cb",
        diffview.actions.conflict_choose "base",
        { desc = "Choose the BASE version of a conflict" },
      },
      {
        "n",
        "<leader>ca",
        diffview.actions.conflict_choose "all",
    ...
    file_panel = {
      ...
      { "n", "i", diffview.actions.listing_style, { desc = "Toggle between 'list' and 'tree' views" } },
      {
        "n",
        "f",
        diffview.actions.toggle_flatten_dirs,
