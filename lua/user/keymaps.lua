...
vim.api.nvim_set_keymap("v", "<leader>fss", ":FzfLua grep_visual<CR>", opts)
-- FzfLua: Search current buffer lines
vim.api.nvim_set_keymap("n", "<leader>fsl", ":FzfLua blines<CR>", opts)
-- FzfLua: Show available FzfLua commands/maps
vim.api.nvim_set_keymap("n", "<leader>fsm", ":FzfLua builtin<CR>", opts)
...
keymap("n", "<leader>fst", "<cmd>FzfLua live_grep<cr>", opts)
keymap("n", "<leader>fsa", "<cmd>FzfLua live_grep<cr>", opts)
