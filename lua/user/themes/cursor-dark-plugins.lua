...
function M.setup()
  ...
  hl("IblIndent", { fg = colors.fg_dark })
  hl("IblWhitespace", { fg = colors.fg_dark })
  ...
  hl("BlinkCmpScrollBarGutter", { bg = colors.bg_light })
  ...
  hl("BlinkCmpKindField", { fg = colors.cyan })
  ...
  hl("BlinkCmpKindProperty", { fg = colors.cyan })
  ...
  hl("ClaudeCodeCode", { fg = colors.orange, bg = colors.bg_light })
