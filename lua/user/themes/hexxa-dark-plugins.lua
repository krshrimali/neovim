...
function M.setup()
  ...
  hl("GitSignsAddLn", { bg = colors.git_add .. "22" })
  hl("GitSignsChangeLn", { bg = colors.git_change .. "22" })
  hl("GitSignsDeleteLn", { bg = colors.git_delete .. "22" })
  hl("GitSignsTopDeleteLn", { bg = colors.git_delete .. "22" })
  hl("GitSignsChangeDeleteLn", { bg = colors.orange .. "22" })
  hl("GitSignsUntrackedLn", { bg = colors.gray2 .. "22" })
  ...
  hl("NeogitDiffDeleteHighlight", { fg = colors.git_delete, bg = colors.git_delete .. "22" })
  hl("NeogitDiffAddHighlight", { fg = colors.git_add, bg = colors.git_add .. "22" })
