...
which_key.add({
  ...
  -- Lspsaga
  { "<leader>llt", "<cmd>Lspsaga term_toggle<cr>", desc="Terminal toggle"},
  { "<leader>llo", "<cmd>Lspsaga outline<cr>", desc="LSP outline"},
  { "<leader>lld", "<cmd>Lspsaga show_line_diagnostics<cr>", desc="Cursor diagnostics"},
  { "<leader>llc", "<cmd>Lspsaga show_cursor_diagnostics<cr>", desc="Cursor diagnostics"},
  ...
  -- NavBar
  { "<leader>nb", "<cmd>Navbuddy<cr>", desc = "NavBar" },
  ...
  -- Project
  { "<leader>tp", "<cmd>Telescope neovim-project discover<cr>", desc = "Switch project" },
