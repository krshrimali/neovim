  ...
  for _, win in ipairs(vim.api.nvim_list_wins()) do
    if vim.api.nvim_win_is_valid(win) then
      ...
      if vim.api.nvim_buf_is_valid(buf) then
        ...
        if buftype == "terminal" then count = count + 1 end
      end
    end
  end
  return count
...
local function test_horizontal_toggle()
  ...
  local success, result = pcall(function() require("user.terminal").toggle_horizontal_terminal() end)
  ...
  success, result = pcall(function() require("user.terminal").toggle_horizontal_terminal() end)
...
local function test_vertical_toggle()
  ...
  local success, result = pcall(function() require("user.terminal").toggle_vertical_terminal() end)
  ...
  success, result = pcall(function() require("user.terminal").toggle_vertical_terminal() end)
