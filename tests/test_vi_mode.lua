...
local function test_vi_mode()
  ...
  local success, result = pcall(function() require("user.terminal").horizontal_terminal() end)
...
local function test_shell_vi_mode()
  ...
  local success, result = pcall(function() require("user.terminal").float_terminal "fish" end)
  ...
  success, result = pcall(function() require("user.terminal").float_terminal "zsh" end)
